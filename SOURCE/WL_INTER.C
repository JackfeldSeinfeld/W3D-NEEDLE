...
void LevelCompleted (void)
{
	...
	{
        if (gamestate.mapon == SECRET3)
           StartCPMusic(ENDOFDEMO_MUS);
		else if (gamestate.mapon == 5 && playstate != ex_secretlevel)
           StartCPMusic(ENDOFDEMO_MUS);
	}
	else
#endif
...
//
	...
	{
#ifdef NEEDLE
       if (mapon >= SECRET1 && mapon != TESMAP) Write(14,4,"secret floor\n completed!");
#endif              
#ifdef SPEAR
#ifndef SPEARDEMO
	  switch(mapon)
	  {
	   case 4: Write(14,4," mans\n"
						  " grosse\n"
						  STR_DEFEATED); break;
	   case 9: Write(14,4,"barnacle\n"
						  "wilhelm\n"
						  STR_DEFEATED); break;
	   case 15: Write(14,4,"  sushi\n"
                           " sakurai\n"
						   STR_DEFEATED); break;
...
#else
		VWB_Bar (PrintX-2,PrintY-2,145,15,0x6f);
#endif
		VH_UpdateScreen ();
#ifndef NEEDLE
		backcolor = 0x9c;
...
#else
	US_Print("  This mod is a DEMO.\n");
	US_Print("Expect things to change\n");
	US_Print("   in the Future.\n");
	US_Print("Thanks for nothing.\n\n");
	US_Print("        JfSf, 2026\n");
#endif
