...
static	byte					sbOldIntMask = -1;
    	volatile byte			huge *sbNextSegPtr;
static	byte					sbDMA = 1,
								sbDMAa1 = 0x83,sbDMAa2 = 2,sbDMAa3 = 3,
								sba1Vals[] = {0x87,0x83,0,0x82},
								sba2Vals[] = {0,2,0,6},
								sba3Vals[] = {1,3,0,7};
        int						sbLocation = -1,sbInterrupt = 7,sbIntVec = 0xf,
								sbIntVectors[] = {-1,-1,0xa,0xb,-1,0xd,-1,0xf,-1,-1,-1};
    	volatile longword		sbNextSegLen;
...
//	Internal routines
		...
		void            SDL_SBIncSegPtr (longword used);
...
//
///////////////////////////////////////////////////////////////////////////
longword SDL_SBPlaySeg(volatile byte huge *data,longword length)
{
	unsigned		datapage;
...
///////////////////////////////////////////////////////////////////////////
//
//	SDL_SBIncSegPtr() - Moves sbNextSegPtr past the processed sound data
//      using huge pointer arithmetic
//
///////////////////////////////////////////////////////////////////////////
